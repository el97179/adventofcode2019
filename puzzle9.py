...
def int_code(array, ind=0):
    ...
    while True:
        try:
            ...
            if opcode == 1:
                if param_mode1 == 0:
                    param1 = array[array[ind+1]]
                elif param_mode1 == 1:
                    param1 = array[ind+1]
                elif param_mode1 == 2:
                    param1 = array[array[ind+1]+rel_base]
                if param_mode2 == 0:
                    param2 = array[array[ind+2]]
                elif param_mode2 == 1:
                    param2 = array[ind+2]
                elif param_mode2 == 2:
                    param2 = array[array[ind+2]+rel_base]
                if param_mode3 == 0:
                    address = array[ind+3]
                elif param_mode3 == 1:
                    address = ind+3
                elif param_mode3 == 2:
                    address = array[ind+3]+rel_base
            ...
            print(e)
            print(f"index = {ind}, address = {address}, extending array...")
            array.append(13)
    return array, output, ind, code99


def part_a():
    int_code(input_array[:])
